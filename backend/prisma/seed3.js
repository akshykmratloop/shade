      ...
      await createResource(
        ...
        [
          ...
          },
          {
            ...
            items: serviceChildSlugs.map((slug) => ({
              resourceType: "SUB_PAGE",
              slug: slug,
            })),
          },
    ...
    await createResource(
      ...
      [
        ...
        },
        {
          title: "projectsGridSection",
          SectionType: "EXTERNAL_ITEMS",
          content: content.project.projectsGridSection,
          sectionVersionTitle: "Project-projectsGridSection",
          items: projectsSlugs.map((slug) => ({
            resourceType: "SUB_PAGE",
            slug: slug,
          })),
