...
import NewsBlogspage from "@/components/news-and-blogs/NewsBlogspage";
import { backendAPI } from "@/contexts/GlobalContext";
import Head from "next/head";
import { useEffect, useState } from "react";

export default function NewsBlogs({ apiData }) {
...
export async function getServerSideProps() {
    try {
        const res = await fetch(`${backendAPI}news-blogs`);
