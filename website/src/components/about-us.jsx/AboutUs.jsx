...
const AboutUs = () => {
    ...
    return (
        <>
            ...
            <section className={`${styles.about_us_wrapper} ${language === 'en' && styles.leftAlign}`}>
                <div className={`container ${styles.main_container}`}>
                        ...
                        <div className={styles.about_content}>
                            ...
                            <div>
                                {currentContent?.main?.descriptions.map((desc, index) => (
                                    <p key={index} className={`${styles.description} ${BankGothic.className}`}>
                                        {desc[language]}
                                    </p>
                                ))}
                            </div>
            ...
            <section className={styles.about_new_project_wrapper}>
                <div className={`container ${styles.main_container}`}>
                    <div className={styles.Client_content}>
                        ...
                        <Button className={`${styles.view_btn} ${language === 'en' && styles.leftAlign}`}>
