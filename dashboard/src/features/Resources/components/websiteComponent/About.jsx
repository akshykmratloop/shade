            ...
            <section className="py-12">
                ...
                >
                    <div className={`flex flex-col gap-6 items-center`}>
                        ...
                        ${checkDifference(currentContent?.["1"]?.content?.subtitle?.[language], liveContent?.["1"]?.content?.subtitle?.[language])}
                        `}
                    ...
                    <div
                        ...
                        {currentContent?.["1"]?.content?.cards?.map((card, index) => (
                            ...
                            >
                                ...
                                ${checkDifference(card?.title?.[language], liveContent?.['1']?.content?.cards?.[index]?.title?.[language])}
                                `}
                                    style={{ fontSize: fontSize.aboutMainPara }}
                                >
                                    {card?.title?.[language]}
                                ...
                                ${checkDifference(card?.description?.[language], liveContent?.['1']?.content?.cards?.[index]?.description?.[language])}
                                `}
