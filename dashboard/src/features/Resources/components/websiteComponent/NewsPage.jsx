...
const NewsBlogspage = ({ language, screen }) => {
    ...
    return (
        <div>
            ...
            {/** main card */}
            <section className={`py-[88px] px-[100px] border ${language === "en" ? "scale-x-100" : "scale-x-[-1]"}`}>
                <div className="container">
                    <div className="flex items-center justify-center gap-[50px] mx-auto rounded-md border border-gray-300 bg-white shadow-md shadow-gray-200">
                        <div className="p-[30px]">
                            <h2 title={mainCard?.title?.[language]} className="text-black text-[20px] font-bold mb-4">
                        ...
                        <img
                            src={mainCard?.image}
                            className="rounded-md mr-1 h-[230px] object-cover object-left"
                            alt=""
                            width={333}
                        />
                    </div>
            ...
            {/* latest card */}
            <section className={`pb-20 ${language === "en" ? "text-left" : ""}`}>
                                ...
                                <div className="p-2 flex-auto flex flex-col justify-between min-h-[68%]">
                                    <div>
                                        ...
                                        <p
                                            ...
                                            className="text-[13px] font-light text-[#001A58]/50 leading-4 mb-5"
                                        >
                                            {TruncateText(card.description[language], 150)}
                                        </p>
                                    </div>
                                    <div className="flex items-center justify-between">
                                        <h6 className="text-[10px] font-light text-gray-600 text-">
                                            {card.date[language]}
                                        </h6>
                                        <button
                                            // onClick={() => router.push(`blog/${card.id}`)}
                                            className="text-[10px] font-bold text-[#00B9F2] border-none bg-transparent cursor-pointer"
                                        >
            ...
            {/* Trending Card */}
            <section className={`${language === "en" ? "text-left" : ""} pb-20 px-20`}>
                <div className="container mx-auto">
                    <div className="flex items-start gap-11 mx-auto rounded-md overflow-hidden bg-[rgba(20,80,152,0.06)]">
