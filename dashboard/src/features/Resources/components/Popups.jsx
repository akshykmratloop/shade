...
const Popups = ({ confirmation, display, setClose }) => {
    ...
    return (
        <div className={`fixed inset-0 flex items-center justify-center z-30 bg-black/50 ${display ? "block" : "hidden"}`}>
            <div ref={modalRef} className="bg-white flex flex-col items-center justify-center p-6 rounded-lg shadow-lg w-[300px] relative">
