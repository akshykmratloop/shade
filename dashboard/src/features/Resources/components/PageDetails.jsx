...
const PageDetails = ({ data, display, setOn }) => {
    ...
    return (
        <div className={`${display ? "block" : "hidden"} fixed z-20 top-0 left-0 w-[100vw] h-screen bg-black bg-opacity-50`}>
            <div ref={pageRef} className="fixed z-30 top-0 right-0 w-[26rem] h-screen bg-[white] dark:bg-[#242933] shadow-xl-custom">
                <button className="bg-transparent hover:bg-stone-900 hover:text-stone-200 dark:hover:bg-stone-300 rounded-full absolute top-7 border border-gray-500 dark:border-stone-700 left-4 p-2 py-2"
                    onClick={() => setOn(false)}>
                        ...
                        <div className="flex flex-col gap-[15px] text-[11px]">
                            ...
                            <div className="flex justify-between">
                                <div className="flex flex-col translate-x-[14px]">
                                    <img src={Assigned} alt="" className="w-[20px] h-[20px] invert" />
                                    <p>Assigned</p>
                                </div>
                                <div className="flex flex-col items-center translate-x-[12px]">
                                    <img src={Edit} alt="" className="w-[20px] h-[20px] invert" />
                                    <p>Edit</p>
                                </div>
                                <div className="flex flex-col items-center translate-x-[12px]">
                                    <img src={Verify} alt="" className="w-[20px] h-[20px] invert" />
                                    <p>Verify ({"Level 2"}) </p>
                                </div>
                                <div className="flex flex-col items-center translate-x-[0px]">
                                    <img src={Publisher} alt="" className="w-[20px] h-[20px] invert" />
                                    <p>Publish</p>
                                </div>
                            </div>
                        </div>
