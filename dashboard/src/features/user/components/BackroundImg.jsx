...
const BackroundImage = () => {
    ...
    return (
        <div className='mx-auto w-full max-w-4xl l-bg flex-3' ref={bgRef} style={{ backgroundImage: `linear-gradient(#333333d1,rgba(0, 0, 0, 0.2)),url(${bgImg[imgRepeator]})` }}> {/* the bg is set in app.css */}
