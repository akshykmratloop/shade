  ...
  return (
    <div className={`relative ${baseClass} mt-2`}>
      ...
      <label
        ...
        className={`flex justify-center gap-2 items-center w-full border border-stone-500 rounded-md px-3 py-2 cursor-pointer bg-[white] dark:bg-[#2a303c] text-gray-700 ${inputClass}`}
      >
