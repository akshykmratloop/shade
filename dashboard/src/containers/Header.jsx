...
function Header({ openResetPass }) {
    ...
    return (
        <div className="flex justify-between items-center bg-base-100 z-10 shadow-md pb-0 h-[70px]">
            ...
            <div className="flex">
                {/* <label htmlFor="left-sidebar-drawer" className="btn btn-ghost ml-4 btn-circle drawer-button">
